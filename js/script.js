...
*/
var musicaMario = new Audio('./media/sons/trilhasonoramario.mp3');
const jumpSound = new Audio('./media/sons/jump.mp3');
const selectSound = new Audio('./media/sons/undertale-select.mp3');
const coinSound = new Audio('./media/sons/coin-audio.mp3');
var localGameOver = './media/morte/game-over-mario.png';
...
function startGame() {
    ...
    scoreInterval = setInterval(() => {
        ...
        if (score >= 500 && !tardeAtivada) {
            ...
            musicaMario.pause();
            musicaMario = new Audio('./media/sons/HoraDeAventura.mp3');
            musicaMario.play();
            tardeAtivada = true;
        }
        if (score >= 1000 && !noiteAtivada) {
            ...
            musicaMario.pause();
            musicaMario = new Audio('./media/sons/silkSong.mp3');
            musicaMario.play();
            noiteAtivada = true;
        }
        if (score >= 1500 && !infernoAtivado) {
            ...
            clouds.src = './media/minecraft-ghast.gif';
            musicaMario.pause();
            musicaMario = new Audio('./media/sons/DoomEternal.mp3');
            musicaMario.play();
...
function escolhaPersonagem(personagem) {
    ...
    let marioGifPath = './media/mario.gif';
    let gameOverImagePath = `./media/morte/game-over-mario.png`;
    let mudarDirecao = false;

    switch (personagem) {
        case 'mario':
            marioGifPath = './media/mario.gif';
            gameOverImagePath = `./media/morte/game-over-mario.png`;
            break;
        case 'sonic':
            marioGifPath = './media/sonic.gif';
            gameOverImagePath = `./media/morte/game-over-sonic.png`;
            break;
        case 'megaman':
            marioGifPath = './media/megaman.gif';
            gameOverImagePath = `./media/morte/game-over-megaman.png`;
            break;
        case 'link':
            marioGifPath = './media/link.gif';
            gameOverImagePath = `./media/morte/game-over-link.png`;
            break;
        case 'goku':
            marioGifPath = './media/goku.gif';
            gameOverImagePath = `./media/morte/game-over-goku.png`;
            break;
        case 'jotaro':
            marioGifPath = './media/jotaroA.gif';
            gameOverImagePath = `./media/morte/game-over-jotaro.gif`;
            break;
        case 'hollow':
            marioGifPath = './media/hollow.gif';
            gameOverImagePath = `./media/morte/game-over-hollow.png`;
            mudarDirecao = true;
            break;
        case 'hornet':
            marioGifPath = './media/hornet.gif';
            gameOverImagePath = `./media/morte/game-over-hornet.png`;
            mudarDirecao = true;
            break;
        default:
